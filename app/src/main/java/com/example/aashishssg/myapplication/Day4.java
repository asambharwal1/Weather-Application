...
public class Day4 extends Fragment {
    ...
    public synchronized View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_day4, null);
        setHasOptionsMenu(true);


        System.out.println("THE SIZE IS "+data.size());
        largeText = (TextView) v.findViewById(R.id.bigtextPage4);
        smallText = (TextView) v.findViewById(R.id.textPage4);
        icon = (ImageView) v.findViewById(R.id.imagePage4);
