...
public class Day2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_day2, null);
        setHasOptionsMenu(true);

        System.out.println("THE SIZE IS "+data.size());
        largeText = (TextView) v.findViewById(R.id.bigtextPage2);
        smallText = (TextView) v.findViewById(R.id.textPage2);
        icon = (ImageView) v.findViewById(R.id.imagePage2);
